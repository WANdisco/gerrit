...
PREVIOUS_ALLOWED_RP_GERRIT_VERSIONS+=( "v2.13.11-RP-1.9.4.1" "v2.13.12-RP-1.9.5.1" "v2.13.12-RP-1.9.6.1" "v2.13.12-RP-1.9.6.2")
PREVIOUS_ALLOWED_RP_GERRIT_VERSIONS+=( "v2.13.12-RP-1.9.7.3" "v2.13.12-RP-1.9.7.4-hotfix" "v2.13.12-RP-1.9.7.5-hotfix" "v2.13.12-RP-1.9.7.6-hotfix" )
PREVIOUS_ALLOWED_RP_GERRIT_VERSIONS+=( "v2.13.12-RP-1.9.7.7-hotfix" "v2.13.12-RP-1.9.7.8-HF5" "v2.13.12-RP-1.9.7.8-hotfix" )
PREVIOUS_ALLOWED_RP_GERRIT_VERSIONS+=( "v2.13.12-RP-1.9.8.1")
