...
public class ChangeHookRunner implements ChangeHooks, LifecycleListener {
    ...
    public ChangeHookRunner(final WorkQueue queue,
      ...
      final SchemaFactory<ReviewDb> schema) {
        ...
        initReplicatedEventsManager();
    }

    private void initReplicatedEventsManager() {
        // Initialise the replicated events manager
        ReplicatedEventsManager hookOnListeners = ReplicatedEventsManager.hookOnListeners(this,schema);
