...
public class CopyApprovals extends SiteProgram {
  ...
  private int threads = 0; // value is picked up in the index impl when 0 is detected ( if not overriden ).
  ...
  private Injector createSysInjector() {
    ...
    if (indexType.isLucene()) {
      // Uses --threads variable, with index.batchThreads default, same as reindex.
      indexModule =
