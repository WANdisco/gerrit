...
public final class IndexToReplicateDelayed implements Delayed {
  ...
  public IndexToReplicateDelayed(int indexNumber, String projectName, Instant lastUpdatedOn) {
  ...
  @SuppressWarnings("unused") // TODO: Check the construction around this class...
