...
public final class ReplicationConstants {
  ...
  /**
   * Disable the copy approval migration process by system property or environment option.
   */
  public static final String COPY_APPROVAL_MIGRATION_DISABLED = "gerrit_copy_approval_migration_disabled";
  ...
  public static final String GERRIT_REPLICATED_CACHES_ALLOWED_TO_REPLICATE_VALUES = "gerrit.replicated.caches.allowed.to.replicate.values";
