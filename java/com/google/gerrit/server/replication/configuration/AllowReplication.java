...
public final class AllowReplication {
  ...
  /**
   * There are times during tests where we may want to flip the value of replicationDisabled in the
   * gerrit server config.
   * @param replicationDisabled
   */
  public void setReplicationDisabledServerConfig(boolean replicationDisabled) {
     config.setBoolean("wandisco", null, "gerritmsReplicationDisabled", replicationDisabled);
