...
public class SingletonEnforcement {
  ...
  private static final Set<String> singletonEnforcement = new HashSet<>();
   ...
   *
   * @param className Name of class to enforce only 1 instance.
   */
   ...
   *
   * @param className Remove class from singleton enforcement set.
   */
