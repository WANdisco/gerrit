...
public interface ReplicatedCacheFactory {
     ...
     */
    <K, V> Cache<K, V> createReplicatedCache(String cacheName, Cache<K, V> cache, String projectToReplicateAgainst, Class<K> keyClass);
     ...
     * @param <V> Any object used as a value type for a Cache
     */
    <K, V> Cache<K, V> createReplicatedCache(String cacheName, Cache<K, V> cache, ProjectNameCallback<K> projectToReplicateAgainst, Class<K> keyClass);
     ...
     */
    <K, V> LoadingCache<K, V> createReplicatedLoadingCache(String cacheName, LoadingCache<K, V> cache, String projectToReplicateAgainst, Class<K> keyClass);
     ...
     * @param <V> Any object used as a value type for a LoadingCache
     */
    <K, V> LoadingCache<K, V> createReplicatedLoadingCache(String cacheName, LoadingCache<K, V> cache, ProjectNameCallback<K> projectToReplicateAgainst, Class<K> keyClass);
}
