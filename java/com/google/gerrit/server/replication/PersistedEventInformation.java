...
public class PersistedEventInformation {
   ...
   * or a max count of events it will be atomically renamed into the parent location with the final event name.
   */
  public PersistedEventInformation(final ReplicatedEventsCoordinator replicatedEventsCoordinator, EventWrapper originalEvent) throws IOException, InvalidEventFilenameException {
    this(replicatedEventsCoordinator,
        new EventFilename(originalEvent,
   ...
   * See {@link EventFilename#EventFilename(EventWrapper, String)} ()} ()} for how
