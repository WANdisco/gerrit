...
public class NonReplicatedEventsCoordinatorImpl implements ReplicatedEventsCoordinator {
  ...
  @Override
  public ReplicatedCacheWatcher getReplicatedCacheWatcher() {
    throw new UnsupportedOperationException("getReplicatedCacheWatcher: Unable to get access to replicated objects when not using replicated entry points.");
  }
