...
public class ReplicatedEventsCoordinatorImpl implements ReplicatedEventsCoordinator {
  ...
  @Override
  public <K, V> Cache<K, V> createReplicatedCache(String cacheName, Cache<K, V> cache, String projectToReplicateAgainst) {
    return isReplicationEnabled() ? new ReplicatedCacheImpl<>(this, cacheName, cache, projectToReplicateAgainst) : cache;
  }

  @Override
  public <K, V> Cache<K, V> createReplicatedCache(String cacheName, Cache<K, V> cache, ProjectNameCallback<K> projectToReplicateAgainst) {
    return isReplicationEnabled() ? new ReplicatedCacheImpl<>(this, cacheName, cache, projectToReplicateAgainst) : cache;
  }

  @Override
  public <K, V> LoadingCache<K, V> createReplicatedLoadingCache(String cacheName, LoadingCache<K, V> cache, String projectToReplicateAgainst) {
    return isReplicationEnabled() ? new ReplicatedLoadingCacheImpl<K, V>(this, cacheName, cache, projectToReplicateAgainst) : cache;
  }

  @Override
  public <K, V> LoadingCache<K, V> createReplicatedLoadingCache(String cacheName, LoadingCache<K, V> cache, ProjectNameCallback<K> projectToReplicateAgainst) {
    return isReplicationEnabled() ? new ReplicatedLoadingCacheImpl<K, V>(this, cacheName, cache, projectToReplicateAgainst) : cache;
  }
