...
import com.google.gerrit.server.replication.ReplicatedCacheFactory;
...
public interface ReplicatedEventsCoordinator extends SysInjectable, LifecycleListener, ReplicatedCacheFactory {
  ...
  ReplicatedCacheWatcher getReplicatedCacheWatcher();
