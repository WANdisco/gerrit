...
import com.google.gerrit.server.replication.PersistedEventInformation;
...
public class ReplicatedOutgoingEventWorker implements Runnable, ReplicatedStoppable {
  ...
  @Override
  public void stop() {
    logger.atInfo().log("Stopping outgoing worker on shutdown.");
  ...
  private void setNewCurrentEventsFile(String projectName, final EventWrapper originalEvent) {
    ...
    } catch (IOException | InvalidEventFilenameException e) {
