...
public class ReplicatedLoadingCacheImpl<K, V> extends ReplicatedCacheImpl<K, V> implements LoadingCache<K, V>{
    ...
    public ReplicatedLoadingCacheImpl(ReplicatedEventsCoordinator replicatedEventsCoordinator,
                                      final String cacheName, Cache<K, V> cache, String projectToReplicateAgainst, Class<K> keyClass){
        super(replicatedEventsCoordinator, requireNonNull(cacheName), requireNonNull(cache), requireNonNull(projectToReplicateAgainst), requireNonNull(keyClass));
    ...
    public ReplicatedLoadingCacheImpl(ReplicatedEventsCoordinator replicatedEventsCoordinator,
                                      final String cacheName, Cache<K, V> cache, @NonNull ProjectNameCallback<K> projectNameCallback, Class<K> keyClass){
        super(replicatedEventsCoordinator, requireNonNull(cacheName), requireNonNull(cache), requireNonNull(projectNameCallback), requireNonNull(keyClass));
        this.loadingCache = (LoadingCache<K, V>) cache;
    }
