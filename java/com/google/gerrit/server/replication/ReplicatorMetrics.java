...
public class ReplicatorMetrics {
  ...
  private static final Multiset<String> cachePutsSent = ConcurrentHashMultiset.create();
  ...
  public static void addToCachePutsSent(final String cacheName){ cachePutsSent.add(cacheName); }
