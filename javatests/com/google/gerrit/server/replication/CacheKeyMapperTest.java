...
public class CacheKeyMapperTest extends AbstractReplicationSetup {
  ...
  public void testShowWDGsonSerializationUsingWDArgumentTypeField() throws IOException {
    ...
    Project.NameKey myProject = Project.nameKey(projectName);
  ...
  public void testUsingCustomGsonDeserializer_CacheObjectCallWrapper() throws IOException, InvalidEventJsonException, ClassNotFoundException {
    ...
    List<?> args = Arrays.asList(myProject);
    ...
    ProjectCacheImpl projectCache = mock(ProjectCacheImpl.class);
    dummyTestCoordinator.getReplicatedCacheWatcher().watchObject(cacheName, projectCache);
    ...
    Assert.assertNotNull("ReplicatedEvent was null after de-serialising from JSON!", replicatedEvent);
